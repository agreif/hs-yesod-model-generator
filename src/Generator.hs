...
data BCrudModel = BCrudModel
  { bCrudModelName :: Text,
    ...
    bCrudModelAddPostNeedsCurRoute :: Bool,
    bCrudModelEditPostNeedsCurRoute :: Bool,
  ...
  toJSON o =
    object
      [ "name" .= bCrudModelName o,
        ...
        "addPostNeedsCurRoute" .= bCrudModelAddPostNeedsCurRoute o,
        "editPostNeedsCurRoute" .= bCrudModelEditPostNeedsCurRoute o,
